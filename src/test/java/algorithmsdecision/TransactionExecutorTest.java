...
import static algorithmsdecision.Status.PENDING;
import static algorithmsdecision.Status.SUCCEEDED;
...
public class TransactionExecutorTest {
    ...
    @Test
    public void testExecuteBankAccountStatusOk() {

        test.executeTransactions(transactions, accounts);
        assertEquals(SUCCEEDED, transactions.get(0).getStatus());
        assertEquals(SUCCEEDED, transactions.get(1).getStatus());
        assertEquals(PENDING, transactions.get(2).getStatus());
