...
public class BattleFieldTest {
    ...
    public void fight() {
        ...
        assertEquals(33, characterArcher.getHitPoint());
        assertEquals(0, characterWarrior.getHitPoint());
    }
    ...
    public void fightCloseTogether() {
        ...
        assertTrue(battleField.getRound() > 0);
        assertTrue(!characterArcher.isAlive() || !characterWarrior.isAlive());
        assertEquals(-4, characterArcher.getHitPoint());
        assertEquals(57, characterWarrior.getHitPoint());
